...
export async function importSkill(userId:string,raw:unknown){
 ...
 try{
  ...
  result.draft.content=appendSupportingFiles(makeAgentSkill(result.draft.content,result.draft.title,result.draft.summary),input.files);
