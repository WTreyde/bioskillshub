...
Deployment requires the additive migration, rebuild/restart and optional labelled demo import in docs/team/wojtek.md. This branch builds on PR #17; merge/deploy the mobile fixes first or include their ancestry. No integration database, credentials, tunnel or compute configuration was changed here.
